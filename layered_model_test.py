...
def test_define_dense_model_single_layer():
    ...
    assert model.layers[0].input_shape == (43,), " input_shape is not correct"
    assert model.layers[0].output_shape == (1,), " output_shape is not correct"
...
def test_define_dense_model_with_hidden_layer():
    ...
    assert model.layers[0].input_shape == (43,), " input_shape is not correct"
    assert model.layers[0].output_shape == (11,), " output_shape is not correct"
    assert model.layers[1].output_shape == (1,), " output_shape is not correct"
